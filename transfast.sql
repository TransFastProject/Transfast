...
INSERT INTO `responsavel` (`res_cpf`, `nome`, `email`, `senha`, `genero`, `telefone`, `data_nascimento`, `cep`, `rua`, `bairro`, `numero`, `complemento`, `foto`) VALUES
	...
	('12232243304', 'Winnie', 'winniestefany303@gmail.com', '$2y$10$Gn6ExpukUM.gLYgwHEceTOOBdmNhwu6g6byPxUN8Uuq0gKRufvEVO', 'Feminino', '11943864922', '2000-03-30', '12345220', 'Rua Jose Serra', 'Jardim N Sei Oq', '42', 'Casa 2', '../img_usuarios/blu-disc.png');
...
INSERT INTO `transporte` (`trans_id`, `moto_cpf`, `nome`, `monitor`, `placa`, `n_assentos`, `estado`, `cidade`, `cep`, `bairro`, `nota`, `codigo`) VALUES
	(1, 'inexistente', 'inexistente', 'inexistente', 'ghd-2310', 15, 'indefinido', 'indefinido', '22000', 'indefinido', 0 , 'nenhum123');
...
INSERT INTO `crianca` (`cria_id`, `res_cpf`, `trans_id`, `nome`, `idade`, `genero`, `data_nascimento`, `escola`, `deficiencia`, `presenca`, `valor`, `foto`) VALUES
	(1, '000.000.000-00', 2, 'Sem Dados', 0, 'Sem Dados', '0000-00-00', 'Sem Dados', 'visual', 'ausente', 0.00, NULL),
	(2, '200.200.200-20', 2, 'samantha', 6, 'feminino', '2005-02-05', 'josefina pereira', 'cognitiva', 'presente', 100.00, NULL),
	(3, '200.200.200-20', 2, 'samantha', 6, 'feminino', '2005-02-05', 'josefina pereira', 'tetraplegico', 'ausente', 150.00, NULL),
	(4, '12232243304', 2, 'Winniezinha', 8, 'Masculino', '2016-03-30', 'Emef', 'Visual', 'presente', NULL, '../img_usuarios/blu-disc.png'),
	(5, '12232243304', NULL, 'Nathan', NULL, 'Masculino', '13/05/2005', 'emef', 'Nenhuma', NULL, NULL, '../img_usuarios/image 5.png');
