		...
		<div id="conteudo_criancas">
			...
			if ($nome_escola == "?" || $nome_escola == "Sem Dados") {
				...
				if ($result3 !== false && $result3->num_rows > 0) {
					...
					<div class="criancas_foto">';
					if (!empty($row['foto'])) {
						echo'<img id="previewFoto" src="'.$row['foto'].'" style="width: 10vw; height: 10vw; object-fit: cover; border-radius: 100%">';
					}else{
						echo'<img id="previewFoto" src="../img/fundo_foto_padrao.png" style="width: 10vw; height: 10vw; object-fit: cover; border-radius: 100%">';
					}
					echo '
					</div>
