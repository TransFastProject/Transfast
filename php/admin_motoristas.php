...
<head>
    <title>Listagem dos Motoristas</title>
    <meta charset="utf-8">
...
<body>
    <div id="gere_menu">
        ...
        <div>
            ...
            <div id="gere_local"><a href="admin_motoristas.php">Motoristas</a></div><br />
    ...
    <div id="gere_conteudo">
        <div id="listagem_titulo">
            <h1>Listagem Dos Motoristas</h1>
        </div>
        <?php
    include "conexao.php";
    $query = mysqli_query($sql,"select * from motorista")
    
    ?>

    <table id="tableMotorista" border="1">
        <tr>
